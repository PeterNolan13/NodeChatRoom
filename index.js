...
var io = require("socket.io")(http); //IO is going to be how we communicate 
//between clients
...
//Use express to serve up static files(css, js, other htmls besides index) so that
//our page can be pretty
